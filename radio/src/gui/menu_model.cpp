...
#endif
  CASE_FRSKY(menuTelemetryFrskySetup)
...
void menuModelSetup(uint8_t event) {
  ...
  MENU_TAB({0,												// Page number !!
			0,												// ITEM_MODEL_NAME
			CASE_PCBTARANIS(0) 2|NAVIGATION_LINE_BY_LINE,	// ITEM_MODEL_BITMAP, ITEM_MODEL_TIMER1
			CASE_PERSISTENT_TIMERS(0) 0,					// ITEM_MODEL_TIMER1_PERSISTENT, ITEM_MODEL_TIMER1_MINUTE_BEEP
			0,												// ITEM_MODEL_TIMER1_COUNTDOWN_BEEP
			2|NAVIGATION_LINE_BY_LINE,						// ITEM_MODEL_TIMER2
			CASE_PERSISTENT_TIMERS(0) 0, 					// ITEM_MODEL_TIMER2_PERSISTENT, ITEM_MODEL_TIMER2_MINUTE_BEEP
			0,												// ITEM_MODEL_TIMER2_COUNTDOWN_BEEP
			0,												// ITEM_MODEL_EXTENDED_LIMITS
			1,												// ITEM_MODEL_EXTENDED_TRIMS
			0,												// ITEM_MODEL_TRIM_INC
			CASE_PCBTARANIS(LABEL(Throttle)) 0,				// ITEM_MODEL_THROTTLE_LABEL, ITEM_MODEL_THROTTLE_REVERSED
			0,												// ITEM_MODEL_THROTTLE_TRACE
			0,												// ITEM_MODEL_THROTTLE_TRIM
			CASE_CPUARM(LABEL(PreflightCheck)) CASE_CPUARM(0) 0,	// ITEM_MODEL_PREFLIGHT_LABEL, ITEM_MODEL_CHECKLIST_DISPLAY, ITEM_MODEL_THROTTLE_WARNING
			7,												// ITEM_MODEL_SWITCHES_WARNING
			POT_WARN_ITEMS() NAVIGATION_LINE_BY_LINE | (NUM_STICKS+NUM_POTS+NUM_ROTARY_ENCODERS-1),	// ITEM_MODEL_POT_WARNING, ITEM_MODEL_BEEP_CENTER
			...
			IF_INTERNAL_MODULE_ON(HAS_RF_PROTOCOL_FAILSAFE(g_model.moduleData[0].rfProtocol) ? (uint8_t)2 : (uint8_t)1),	//ITEM_MODEL_INTERNAL_MODULE_BIND
			IF_INTERNAL_MODULE_ON(FAILSAFE_ROWS(INTERNAL_MODULE)),			//ITEM_MODEL_INTERNAL_MODULE_FAILSAFE
		    ...
		    (IS_MODULE_XJT(EXTERNAL_MODULE) && IS_D8_RX(EXTERNAL_MODULE)) ? (uint8_t)1 : (IS_MODULE_PPM(EXTERNAL_MODULE) || IS_MODULE_XJT(EXTERNAL_MODULE) || IS_MODULE_DSM2(EXTERNAL_MODULE)) ? (uint8_t)2 : HIDDEN_ROW,		// ITEM_MODEL_EXTERNAL_MODULE_BIND
  ...
  MENU_TAB({0,													// Page number !!
			0,													// ITEM_MODEL_NAME
			CASE_PCBTARANIS(0) 2,								// ITEM_MODEL_TIMER1
			CASE_PERSISTENT_TIMERS(0) 0,	 					// CASE_PERSISTENT_TIMERS(ITEM_MODEL_TIMER1_PERSISTENT), ITEM_MODEL_TIMER1_MINUTE_BEEP
			0,													// ITEM_MODEL_TIMER1_COUNTDOWN_BEEP
			2,													// ITEM_MODEL_TIMER2
			CASE_PERSISTENT_TIMERS(0) 0,						// CASE_PERSISTENT_TIMERS(ITEM_MODEL_TIMER2_PERSISTENT), ITEM_MODEL_TIMER2_MINUTE_BEEP
			0,													// ITEM_MODEL_TIMER2_COUNTDOWN_BEEP
			0,													// ITEM_MODEL_EXTENDED_LIMITS
			0,													// ITEM_MODEL_EXTENDED_TRIMS
			1,													// ITEM_MODEL_TRIM_INC
			0,													// CASE_PCBTARANIS(ITEM_MODEL_THROTTLE_LABEL), ITEM_MODEL_THROTTLE_REVERSED
			CASE_PCBTARANIS(LABEL(Throttle)) 0,					// ITEM_MODEL_THROTTLE_TRACE
			0,													// ITEM_MODEL_THROTTLE_TRIM
			CASE_CPUARM(LABEL(PreflightCheck)) CASE_CPUARM(0) 0,	// ITEM_MODEL_PREFLIGHT_LABEL, ITEM_MODEL_CHECKLIST_DISPLAY, ITEM_MODEL_THROTTLE_WARNING
			6,													// ITEM_MODEL_SWITCHES_WARNING
			NUM_STICKS+NUM_POTS+NUM_ROTARY_ENCODERS-1,			// CASE_PCBTARANIS(ITEM_MODEL_POT_WARNING), ITEM_MODEL_BEEP_CENTER
			0,													// ITEM_MODEL_PROTOCOL
			0,													// ITEM_SETUP_TELCOM
			0,													// ITEM_TELCOM_BAUD
			0,													// ITEM_SETUP_MIRRCOM
...
void menuTelemetryFrskySetup(uint8_t event) {
  MENU(STR_MENUTELEMETRY, menuTabModel, e_Telemetry, ITEM_TELEMETRY_MAX+1
			...
			, CHANNEL_ROWS
			, CASE_CPUARM(CHANNEL_ROWS) CASE_CPUARM(CHANNEL_ROWS) RSSI_ROWS
			, USRDATA_LINES 0
			, 0
			, IF_FAS_OFFSET(0) CASE_CPUARM(0) CASE_VARIO(LABEL(Vario)) CASE_VARIO(0) CASE_VARIO(VARIO_RANGE_ROWS) CASE_PCBTARANIS(LABEL(TopBar)) CASE_PCBTARANIS(0) SCREEN_TYPE_ROWS
			, 2
			, 2
			, 2
			, 2
			...
			, 2
			, 2
			, CASE_CPUARM(SCREEN_TYPE_ROWS) CASE_CPUARM(2) CASE_CPUARM(2) CASE_CPUARM(2) CASE_CPUARM(2)});
