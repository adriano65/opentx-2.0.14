...
void menuModelSetup(uint8_t event) {
  ...
  MENU_TAB({ 0,														// ITEM_MODEL_NAME
			 ...
			 CASE_PERSISTENT_TIMERS(0) 0, 							// ITEM_MODEL_TIMER1_PERSISTENT
			 0,														// ITEM_MODEL_TIMER1_COUNTDOWN_BEEP
			 2,														// ITEM_MODEL_TIMER2
			 CASE_PERSISTENT_TIMERS(0) 0,							// ITEM_MODEL_TIMER2_PERSISTENT
			 0,														// ITEM_MODEL_TIMER2_COUNTDOWN_BEEP
			 0,														// ITEM_MODEL_TIMER2_COUNTDOWN_BEEP
			 1,														// ITEM_MODEL_EXTENDED_LIMITS
			 0,														// ITEM_MODEL_EXTENDED_LIMITS
		   	 CASE_PCBTARANIS(LABEL(Throttle)) 0,
			 0,
		     0,
			 CASE_CPUARM(LABEL(PreflightCheck)) CASE_CPUARM(0) 0,	// ITEM_MODEL_EXTENDED_TRIMS
			 6,														// ITEM_MODEL_TRIM_INC
