...
void menuModelSetup(uint8_t event) {
  ...
  MENU_TAB({ 0								// ITEM_MODEL_NAME
			, 0								// ITEM_MODEL_BITMAP
			, CASE_PCBTARANIS(0) 2|NAVIGATION_LINE_BY_LINE			// ITEM_MODEL_TIMER1
  ...
  MENU_TAB({0,											// ITEM_MODEL_NAME
	    0,											// ITEM_MODEL_TIMER1
	    CASE_PCBTARANIS(0) 2,								// ITEM_MODEL_TIMER1_MINUTE_BEEP, ITEM_MODEL_TIMER1_COUNTDOWN_BEEP, 
	    CASE_PERSISTENT_TIMERS(0) 0, 							// CASE_PERSISTENT_TIMERS(ITEM_MODEL_TIMER1_PERSISTENT)  
	    0,											// ITEM_MODEL_TIMER2
	    2,											// ITEM_MODEL_TIMER1_MINUTE_BEEP, ITEM_MODEL_TIMER2_COUNTDOWN_BEEP
	    CASE_PERSISTENT_TIMERS(0) 0,							// CASE_PERSISTENT_TIMERS(ITEM_MODEL_TIMER2_PERSISTENT)
	    0,											// ITEM_MODEL_EXTENDED_LIMITS
