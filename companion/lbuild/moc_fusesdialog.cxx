...
void fusesDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        fusesDialog *_t = static_cast<fusesDialog *>(_o);
        switch (_id) {
        case 0: _t->on_readFuses_clicked(); break;
        case 1: _t->on_resetFuses_EEdelete_clicked(); break;
        case 2: _t->on_resetFuses_EEprotect_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData fusesDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject fusesDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_fusesDialog,
      qt_meta_data_fusesDialog, &staticMetaObjectExtraData }
};
