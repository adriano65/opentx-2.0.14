...
static const char qt_meta_stringdata_CompareDialog[] = {
    "CompareDialog\0\0on_printButton_clicked()\0"
    "on_printFileButton_clicked()\0"
};
...
void CompareDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_printFileButton_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData CompareDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CompareDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CompareDialog,
      qt_meta_data_CompareDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CompareDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CompareDialog))
